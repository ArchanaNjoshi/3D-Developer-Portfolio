...
import archana from "../assets/archana3.png";
import archana4 from "../assets/archana4.svg";
const Navbar = () => {

  // Keeps track of where we are currently in the page
  ...
  return (
    ...
    >
      ...
      items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={archana4} alt="logo" className="w-9 h-9 object-contain" />
